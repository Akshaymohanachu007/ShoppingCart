...
function CartList(){
    ...
    const {cartItem,handleRemoveFromCart} = useContext(ShoppingCartContext)
    ...
    return <div className="max-w-5xl mx-auto max-md:max-w-xl py-4">
        ...
        <div className="md:col-span-2 space-y-4">
            {
                ...
                : <h1>No items available in Cart!Please add some </h1>
            }
        </div>
        <div className="bg-gray-100 rounded-sm p-4 h-max">
            ...
            <div className="mt-5 flex gap-2 ">
                ...
                <button onClick={()=> navigate('/product-List')} className="text-sm px-4 py-3 bg-black text-white font-extrabold">
                    Continue Shopping
                </button>
            </div>
        </div>
